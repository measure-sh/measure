...
comment on column sessions.app_id is 'app id of the app this session belongs to';
...
comment on column sessions.timestamp is 'utc timestamp at the time of session ingestion';