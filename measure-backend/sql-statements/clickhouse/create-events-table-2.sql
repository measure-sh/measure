...
(
    ...
    `gesture_long_click.touch_down_time` DateTime64(9, 'UTC'),
    `gesture_long_click.touch_up_time` DateTime64(9, 'UTC'),
    ...
    `gesture_click.touch_down_time` DateTime64(9, 'UTC'),
    `gesture_click.touch_up_time` DateTime64(9, 'UTC'),
    ...
    `gesture_scroll.touch_down_time` DateTime64(9, 'UTC'),
    `gesture_scroll.touch_up_time` DateTime64(9, 'UTC'),
