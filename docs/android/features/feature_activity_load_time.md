...
An important attribute called `app_launch_type_cold` is also automatically added to the span to indicate if the Activity
being loaded as part of a [cold](feature_app_launch.md#cold-launch) launch.
...
|----------------------|------------------------------------------------------------------|
| app_launch_type_cold | Indicates if the Activity was launched as part of a cold launch. |
