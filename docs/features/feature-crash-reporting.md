...
A screenshot of the app is captured when an app crashes on Android. This feature is enabled by default and can be
...
A screenshot of the app is captured when an app crashes on Flutter. This feature is enabled by default and can be
configured using the following options at the time of SDK initialization:
