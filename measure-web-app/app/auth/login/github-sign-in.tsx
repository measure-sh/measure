...
export default function GitHubSignIn() {
  return <button className="justify-center hover:bg-yellow-200 active:bg-yellow-300 focus-visible:bg-yellow-200 border border-black rounded-md font-display text-black transition-colors duration-100 py-2 px-4 w-full" onClick={() => doGitHubLogin()}><GitHubLogo /><span>Login with GitHub</span></button>
}