...
const InfoCircleAppAdoption = ({ message, value, users, totalUsers, title }: InfoCircleAppAdoptionProps) => {
    return (
        <div className="flex flex-col items-center">
            <div className={`flex flex-col group relative items-center justify-center w-64 aspect-square rounded-full border border-black border-4 hover:bg-neutral-800/25 transition-colors duration-100`}>
                ...
                <div className="py-1"/>
                {message==="" && <p className="text-black font-sans text-sm">{formatter.format(users)}/{formatter.format(totalUsers)} users</p>}
