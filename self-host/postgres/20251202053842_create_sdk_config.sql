...
create table if not exists measure.sdk_config (
    ...
    error_timeline_duration int not null,
    ...
    crash_timeline_sampling_rate float8 not null,
    anr_take_screenshot boolean not null,
    anr_timeline_sampling_rate float8 not null,
...
comment on column measure.sdk_config.error_timeline_duration is 'duration for error timeline';
...
comment on column measure.sdk_config.crash_timeline_sampling_rate is 'sampling rate for timeline with crashes';
comment on column measure.sdk_config.anr_take_screenshot is 'whether to take screenshot on ANR';
comment on column measure.sdk_config.anr_timeline_sampling_rate is 'sampling rate for timeline with ANRs';
