...
comment on column measure.session_targeting_rules.name is 'a user provided name of the rule';
...
comment on column measure.session_targeting_rules.auto_created is 'true if this rule was automatically created, false if created by a user';
