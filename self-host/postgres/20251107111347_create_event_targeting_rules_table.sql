...
comment on column measure.event_targeting_rules.name is 'a user provided name of the rule';
...
comment on column measure.event_targeting_rules.is_default_behaviour is 'whether this rule represents the default behavior';
...
comment on column measure.event_targeting_rules.auto_created is 'true if this rule was automatically created, false if created by a user';
