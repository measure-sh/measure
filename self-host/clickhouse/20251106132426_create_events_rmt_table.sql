...
`usedef_attrs.keys` Array (String),
`usedef_attrs.types` Array (String),
`usedef_attrs.string_vals` Array (String),
`usedef_attrs.bool_vals` Array (Bool),
`usedef_attrs.int64_vals` Array (Int64),
`usedef_attrs.float64_vals` Array (Float64),
