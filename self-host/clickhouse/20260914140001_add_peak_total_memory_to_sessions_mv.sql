...
select
    ...
    maxSimpleState(attribute.device_total_memory) as device_total_memory,
    maxSimpleState(if(type = 'memory_usage', memory_usage.anon_rss + memory_usage.swap, toUInt64(0))) as peak_total_memory,
    maxSimpleState(if(type = 'memory_usage' and memory_usage.app_importance = 'foreground', memory_usage.anon_rss + memory_usage.swap, toUInt64(0))) as peak_total_memory_foreground,
    maxSimpleState(if(type = 'memory_usage' and memory_usage.app_importance = 'user_service', memory_usage.anon_rss + memory_usage.swap, toUInt64(0))) as peak_total_memory_user_service,
    maxSimpleState(if(type = 'memory_usage' and memory_usage.app_importance = 'background', memory_usage.anon_rss + memory_usage.swap, toUInt64(0))) as peak_total_memory_background,
