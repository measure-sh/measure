...
describe("MetricsCard", () => {
  ...
  const createPerceivedCrashFreeSessionsProps = (
    overrides = {},
  ): PerceivedCrashFreeSessionsProps => ({
  ...
  const createAnrFreeSessionsProps = (
    overrides = {},
  ): AnrFreeSessionsProps => ({
  ...
  const createPerceivedAnrFreeSessionsProps = (
    overrides = {},
  ): PerceivedAnrFreeSessionsProps => ({
  ...
  describe("Crash Free Sessions", () => {
    ...
    it("should render different status icons based on value and their colors", () => {
      ...
      const alertTriangleIconYellow = within(cardContent2).getByTestId(
        "alert-triangle-icon",
      );
      ...
      const alertTriangleIconRed = within(cardContent3).getByTestId(
        "alert-triangle-icon",
      );
    ...
    it("should use configurable thresholds for status icon", () => {
      ...
      const cardContent = screen.getByTestId("card-content");
      const warningIcon = within(cardContent).getByTestId(
        "alert-triangle-icon",
      );
  ...
  describe("App Size", () => {
    ...
    it("should show disclaimer when multiple app versions are selected", () => {
      const appSizeProps = createAppSizeProps({
        deltaInBytes: 220,
        multiVersion: true,
      });
      ...
      const cardContent2 = screen.getByTestId("card-content");
      const alertTriangleIcon = within(cardContent2).queryByTestId(
        "alert-triangle-icon",
      );
  ...
  describe("Tooltip Content", () => {
    ...
    it("should render tooltip content for app size", () => {
      ...
      const tooltipContent = screen.getByTestId("tooltip-content");
      expect(tooltipContent).toHaveTextContent(
        "Delta value = App size of selected app version",
      );
      expect(tooltipContent).toHaveTextContent(
        "Good (size decreased or unchanged",
      );
    ...
    it("should render tooltip content for app adoption with session counts", () => {
      ...
      const tooltipContent = screen.getByTestId("tooltip-content");
      expect(tooltipContent).toHaveTextContent(
        "Adoption = (Sessions of selected app versions",
      );
  ...
  describe("Status Icon Display Logic", () => {
    it("should show status icon only for supported metric types with success status and data", () => {
      ...
      const statusIcons1 = cardContent1.querySelectorAll(
        '[data-testid="check-circle-icon"], [data-testid="alert-triangle-icon"]',
      );
      ...
      const { unmount: unmount2 } = render(
        <MetricsCard {...perceivedCrashProps} />,
      );
      const cardContent2 = screen.getByTestId("card-content");
      const statusIcons2 = cardContent2.querySelectorAll(
        '[data-testid="check-circle-icon"], [data-testid="alert-triangle-icon"]',
      );
      ...
      const cardContent3 = screen.getByTestId("card-content");
      const statusIcons3 = cardContent3.querySelectorAll(
        '[data-testid="check-circle-icon"], [data-testid="alert-triangle-icon"]',
      );
      ...
      const { unmount: unmount4 } = render(
        <MetricsCard {...perceivedAnrProps} />,
      );
      const cardContent4 = screen.getByTestId("card-content");
      const statusIcons4 = cardContent4.querySelectorAll(
        '[data-testid="check-circle-icon"], [data-testid="alert-triangle-icon"]',
      );
      ...
      const statusIcons5 = cardContent5.querySelectorAll(
        '[data-testid="check-circle-icon"], [data-testid="alert-triangle-icon"]',
      );
      ...
      const statusIcons6 = cardContent6.querySelectorAll(
        '[data-testid="check-circle-icon"], [data-testid="alert-triangle-icon"]',
      );
    ...
    it("should not show status icon for app adoption", () => {
      ...
      const cardContent = screen.getByTestId("card-content");
      const statusIcons = cardContent.querySelectorAll(
        '[data-testid*="circle-icon"], [data-testid*="triangle-icon"]',
      );
    ...
    it("should not show status icon when loading, error, or no data", () => {
      ...
      // Test loading
      const { rerender } = render(
        <MetricsCard {...baseProps} status={"pending" as const} />,
      );
      let cardContent = screen.getByTestId("card-content");
      let statusIcons = cardContent.querySelectorAll(
        '[data-testid*="circle-icon"], [data-testid*="triangle-icon"]',
      );
      expect(statusIcons).toHaveLength(0);
      ...
      cardContent = screen.getByTestId("card-content");
      statusIcons = cardContent.querySelectorAll(
        '[data-testid*="circle-icon"], [data-testid*="triangle-icon"]',
      );
      expect(statusIcons).toHaveLength(0);
