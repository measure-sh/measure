import LayoutSnapshot, {
  LayoutElementType,
  LayoutSnapshotHighlightBg,
} from "@/app/components/layout_snapshot";
...
describe("LayoutSnapshot", () => {
  ...
  it("renders correctly after fetching layout", async () => {
    ...
    await waitFor(() => {
      expect(
        container.querySelector(".absolute.inset-0.border"),
      ).toBeInTheDocument();
    });
  });
