...
describe('Usage Page (MSW integration)', () => {
    ...
    describe('page load', () => {
        ...
        it('renders pie slices for each app', async () => {
            ...
            expect(screen.getByTestId('pie-slice-b5f3e8a1-6c2d-4f9a-8e7b-1a2b3c4d5e6f')).toBeTruthy()
            expect(screen.getByTestId('pie-slice-c6f4e9b2-7d3e-5a0b-9f8c-2b3c4d5e6f7a')).toBeTruthy()
        })
        ...
        it('renders app name and usage values in pie slices', async () => {
            ...
            expect(screen.getByText(/measure demo: 6200 sessions, 15000 events, 9500 spans/)).toBeTruthy()
    ...
    describe('month selection', () => {
        ...
        it('selecting a different month updates the pie chart data', async () => {
            ...
            await waitFor(() => {
                ...
                expect(screen.getByText(/measure demo: 5000 sessions, 12000 events, 8000 spans/)).toBeTruthy()
                // Mar 2026: "other app" has 2000 sessions, 4000 events, 3000 spans
                expect(screen.getByText(/other app: 2000 sessions, 4000 events, 3000 spans/)).toBeTruthy()
            })
        })
    ...
    describe('upgrade flow', () => {
        ...
        it('click Upgrade to Pro calls PATCH /teams/:teamId/billing/checkout and redirects', async () => {
            ...
            server.use(
                ...
                http.patch('*/api/teams/:teamId/billing/checkout', async ({ request }) => {
            ...
            await waitFor(() => {
                expect(locationSpy).toHaveBeenCalledWith('https://checkout.stripe.com/test-session')
            }, { timeout: 5000 })
    ...
    describe('downgrade flow', () => {
        ...
        it('click Downgrade to Free, confirm dialog, calls PATCH /teams/:teamId/billing/downgrade', async () => {
            ...
            server.use(
                ...
                http.patch('*/api/teams/:teamId/billing/downgrade', async ({ request }) => {
            ...
            const downgradeBtn = screen.getByText('Downgrade to Free').closest('button')!
            await act(async () => {
