...
const DOCS_URLS = [
  ...
  "/docs/getting-started/flutter",
  "/docs/getting-started/react-native",
  "/docs/getting-started/kotlin-multiplatform",
  ...
  "/docs/performance-tracing/screen-load-time",
  ...
  "/docs/network-monitoring/connectivity-changes",
