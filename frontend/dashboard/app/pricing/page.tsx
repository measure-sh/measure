                ...
                <div>
                  <div className="flex justify-between items-center mb-4 gap-2">
                    <div>
                      ...
                      <p className="text-sm py-2 text-muted-foreground font-body">Percentage of sessions with Crashes/ANRs/Bug reports for which we collect timeline (~{SESSION_TIME_PER_ERROR} mins = {EVENTS_PER_SESSION_MINUTE * SESSION_TIME_PER_ERROR} events each)</p>
                    </div>
            ...
            <div className="border-t-2 border-border pt-8">
              <div className="bg-secondary rounded-lg p-4 my-4 space-y-2 text-sm font-body">
                <div className="flex justify-between">
                  <span className="text-secondary-foreground">Sessions per month:</span>
