    ...
    <main className="flex flex-col items-center justify-between selection:bg-yellow-200/75">
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8 font-body">
          {/* Header */}
          <div className="py-16" />
          <h1 className="text-6xl font-display text-black mb-2">Terms of Service</h1>
          <p className="text-gray-600 mb-8">Updated: September 10, 2025</p>
          <h2 className="text-3xl font-display text-black mt-8 mb-4">Measure Cloud</h2>
          <p className="mb-8 text-justify text-lg">
            Please read these terms of service carefully before using our Service.
          </p>

          {/* Interpretation and Definitions */}
          <h3 className="text-2xl font-display text-black mt-8 mb-4">Interpretation and Definitions</h3>

          <h4 className="text-xl font-display text-black mt-6 mb-3">Interpretation</h4>
          <p className="mb-6 text-justify text-lg">
            The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
          </p>

          <h4 className="text-xl font-display text-black mt-6 mb-3">Definitions</h4>
          <p className="mb-4 text-justify text-lg">For the purposes of these Terms of Service:</p>

          <dl className="mb-8 space-y-4 text-lg">
            <div>
              <dt className="font-semibold text-black">Affiliate</dt>
            ...
            <div>
              <dt className="font-semibold text-black">Device</dt>
            ...
            <div>
              <dt className="font-semibold text-black">Feedback</dt>
            ...
            <div>
              <dt className="font-semibold text-black">Free Trial</dt>
            ...
            <div>
              <dt className="font-semibold text-black">Subscriptions</dt>
            ...
            <div>
              <dt className="font-semibold text-black">Terms of Service</dt>
            ...
            <div>
              <dt className="font-semibold text-black">Third-party Social Media Service</dt>
            ...
            <div>
              ...
              <dd className="mt-1 text-justify">refers to measure.sh, accessible from <Link className="underline decoration-2 underline-offset-2 decoration-yellow-200 hover:decoration-yellow-500" href="https://measure.sh">https://measure.sh</Link></dd>
            </div>

            <div>
              <dt className="font-semibold text-black">You/Your</dt>
          ...
          {/* Acknowledgment */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Acknowledgment</h3>
          ...
          {/* Subscriptions */}
          <h3 className="text-2xl font-display text-black mt-8 mb-4">Subscriptions</h3>

          <h4 className="text-xl font-display text-black mt-6 mb-3">Subscription period</h4>
          <p className="mb-4 text-justify text-lg">
          ...
          <h4 className="text-xl font-display text-black mt-6 mb-3">Subscription cancellations</h4>
          <p className="mb-6 text-justify text-lg">
            You may cancel your Subscription renewal either through your Account settings page or by contacting the Company. You will not receive a refund for the fees you already paid for your current Subscription period and you will be able to access the Service until the end of your current Subscription period.
          </p>

          <h4 className="text-xl font-display text-black mt-6 mb-3">Billing</h4>
          <p className="mb-4 text-justify text-lg">
          ...
          <h4 className="text-xl font-display text-black mt-6 mb-3">Fee Changes</h4>
          <p className="mb-4 text-justify text-lg">
          ...
          <h4 className="text-xl font-display text-black mt-6 mb-3">Refunds</h4>
          <p className="mb-4 text-justify text-lg">
          ...
          <h4 className="text-xl font-display text-black mt-6 mb-3">Free Trial</h4>
          <p className="mb-4 text-justify text-lg">
          ...
          {/* User Accounts */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">User Accounts</h3>
          <p className="mb-4 text-justify text-lg">
          ...
          {/* Your Feedback to Us */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Your Feedback to Us</h3>
          <p className="mb-8 text-justify text-lg">
            You assign all rights, title and interest in any Feedback you provide the Company. If for any reason such assignment is ineffective, you agree to grant the Company a non-exclusive, perpetual, irrevocable, royalty free, worldwide right and license to use, reproduce, disclose, sub-license, distribute, modify and exploit such Feedback without restriction.
          </p>

          {/* Links to Other Websites */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Links to Other Websites</h3>
          <p className="mb-4 text-justify text-lg">
          ...
          {/* Termination */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Termination</h3>
          <p className="mb-4 text-justify text-lg">
          ...
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Limitation of Liability</h3>
          <p className="mb-4 text-justify text-lg">
          ...
          <h3 className="text-2xl font-display text-black mt-12 mb-4">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h3>
          <p className="mb-4 text-justify text-lg">
          ...
          {/* Governing Law */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Governing Law</h3>
          <p className="mb-8 text-justify text-lg">
            The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.
          </p>

          {/* Disputes Resolution */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Disputes Resolution</h3>
          <p className="mb-8 text-justify text-lg">
            If you have any concern or dispute about the Service, you agree to first try to resolve the dispute informally by contacting the Company.
          </p>

          {/* For European Union (EU) Users */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">For European Union (EU) Users</h3>
          <p className="mb-8 text-justify text-lg">
            If you are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident.
          </p>

          {/* United States Federal Government End Use Provisions */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">United States Federal Government End Use Provisions</h3>
          <p className="mb-8 text-justify text-lg">
            If you are a U.S. federal government end user, our Service is a &quot;Commercial Item&quot; as that term is defined at 48 C.F.R. §2.101.
          </p>

          {/* United States Legal Compliance */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">United States Legal Compliance</h3>
          <p className="mb-8 text-justify text-lg">
            You represent and warrant that (i) you are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a &quot;terrorist supporting&quot; country, and (ii) you are not listed on any United States government list of prohibited or restricted parties.
          </p>

          {/* Severability and Waiver */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Severability and Waiver</h3>

          <h4 className="text-xl font-display text-black mt-6 mb-3">Severability</h4>
          <p className="mb-6 text-justify text-lg">
            If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
          </p>

          <h4 className="text-xl font-display text-black mt-6 mb-3">Waiver</h4>
          <p className="mb-8 text-justify text-lg">
            Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party&apos;s ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.
          </p>

          {/* Translation Interpretation */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Translation Interpretation</h3>
          <p className="mb-8 text-justify text-lg">
          ...
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Changes to These Terms of Service</h3>
          <p className="mb-4 text-justify text-lg">
          ...
          {/* Contact Us */}
          <h3 className="text-2xl font-display text-black mt-12 mb-4">Contact Us</h3>
          <p className="mb-8 text-justify text-lg">
            If you have any questions about these Terms of Service, you can contact us via email on <Link target="_blank" className="underline decoration-2 underline-offset-2 decoration-yellow-200 hover:decoration-yellow-500" href="mailto:hello@measure.sh">hello@measure.sh</Link>
          </p>

          {/* Self Hosted */}
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Self Hosted</h2>
          <p className="mb-8 text-justify text-lg">
            Please note that the Terms of Service listed above apply specifically to the Measure Cloud (hosted) service. The self-hosted version of the software is governed by the terms of the Apache License 2.0, available in the source code <Link target="_blank" className="underline decoration-2 underline-offset-2 decoration-yellow-200 hover:decoration-yellow-500" href="https://github.com/measure-sh/measure/blob/main/LICENSE">here</Link>.
          </p>
        </div>
