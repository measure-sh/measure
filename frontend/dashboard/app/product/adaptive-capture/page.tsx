  ...
  return (
    <main className="flex flex-col items-center justify-between selection:bg-yellow-200/75">
      ...
      <div className="flex flex-col items-center w-full bg-yellow-100/60">
        <div className="py-16" />
        <h1 className="text-6xl font-display text-black w-full md:w-6xl px-4">Adaptive Capture</h1>
        <div className='py-2' />
        ...
        <div className="w-full md:w-6xl  md:h-full bg-white p-8 rounded-lg shadow-lg mt-12 mb-32 overflow-y-auto">
