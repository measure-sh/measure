  ...
  return (
    <main className="flex flex-col items-center justify-between selection:bg-yellow-200/75">
      ...
      <div className="flex flex-col items-center w-full bg-yellow-100/60">
        <div className="py-16" />
        <h1 className="text-6xl font-display text-black w-full md:w-6xl px-4">Bug Reports</h1>
        <div className='py-2' />
        ...
        <div className="relative w-full max-w-[90vw] md:max-w-6xl h-[400px] md:h-[740px] mt-12 mb-32 mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
          {/* SCALING WRAPPER */}
