...
const seo = {
  ...
  description:
    "Mobile focused, open source alternative to Datadog. Crashes, ANRs, performance, network and full session replays for mobile engineering teams with simple pricing.",
