...
const differentiators: AlternativeDifferentiator[] = [
  {
    ...
    body: (
      <>
        With New Relic you get the stack trace plus breadcrumbs and interaction
        traces, and optionally Mobile Session Replay. But mobile replay is
        sampled, and the events each session sends are capped per harvest, so
        you record a subset of sessions, not all of them.
        <br />
        <br />
        ...
        without relying on a sampler to have kept the session you need. No more
  ...
  },
  {
    ...
    body: (
      <>
        New Relic&apos;s Mobile Session Replay relies on sampling to decide
        which sessions to keep, and the agent&apos;s event pool is capped per
        harvest cycle, so once the cap is hit it starts discarding events. Some
        of these are server controlled but changing other sample rates means
        shipping an app update with new SDK settings.
        <br />
        <br />
        ...
        down whenever you need to. Measure puts you in control.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        are a proprietary SaaS and there is no self-host option. You can read
        the agent, but you can&apos;t see or run the platform that ingests and
        stores your data.
        <br />
        <br />
        Measure is{" "}
  ...
  },
  {
    ...
    body: (
      <>
        New Relic charges on two axes at once: per-gigabyte data ingest and
        per-user seats. This means adding teammates and ingesting more data both
        push the bill up.
        <br />
        <br />
  ...
  },
  {
    ...
    body: (
      <>
        ...
        security and more across one sprawling platform, so mobile is one small
        corner of it. Mobile is one workload among many, and the defaults,
        dashboards and roadmap are shaped by the whole platform rather than by
        mobile alone.
        <br />
        <br />
...
const comparisonRows: AlternativeComparisonRow[] = [
  {
    ...
    measure: true,
    competitor: "Crash reports, replays sampled",
  },
  {
    feature: "ANR detection with full session timelines",
    measure: true,
    competitor: "ANRs, replays sampled",
  },
