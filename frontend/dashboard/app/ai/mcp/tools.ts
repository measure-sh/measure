...
5. Date range (from, to) must be provided, if user hasn't asked for a specific date range, use last 12 months as default.
    ...
    return {
        getDocs: {
            ...
            execute: async ({ userQuery }) => {
                ...
                await reportAiUsage(teamId, userId, source, TEXT_EMBEDDING_MODEL, docSearchResult.inputTokens, 0, null, mcpKey);
