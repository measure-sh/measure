...
export default function About() {
  const team = [
    ...
    {
      name: "Debjeet Biswas",
      profile_pic_url: "https://pbs.twimg.com/profile_images/458950547941228544/XeCMbM9h_400x400.jpeg",
      title: "Head of Infra",
  ...
  return (
    <main className="flex flex-col items-center justify-between selection:bg-yellow-200/75">
      ...
      <div className="flex flex-col items-center w-full">
        ...
        {/* Main description */}
        <div className="py-16" />
        <h1 className="text-5xl font-display leading-relaxed text-black md:w-6xl px-4">For mobile engineers, by mobile engineers</h1>
        <div className="py-4" />
        ...
        <div className='w-full flex items-center flex-col bg-yellow-100/60 py-16 md:py-24'>
          <p className="font-display font-regular text-black text-4xl max-w-4xl text-center px-4">Team</p>
          <div className="py-4" />
          <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-4 md:gap-6 lg:gap-8 p-4 md:p-6 lg:p-8 w-full max-w-6xl">
            {team.map((team, index) => (
              <Link href={team.url} key={index} target="_blank" rel="noopener noreferrer" className="h-full">
                <div className="flex flex-col items-center h-full border border-neutral-800 p-8 rounded-md bg-white shadow-sm">
                  <Image
        ...
        <div className='w-full flex items-center flex-col bg-white py-16 md:py-24'>
          <p className="font-display font-regular text-black text-4xl max-w-4xl text-center px-4">Investors</p>
          <div className="py-8" />
          <div className="flex flex-col md:flex-row gap-8 p-2 items-center max-w-6xl">
            <Image
              src="/images/investor_logos/picus.png"
            ...
            />
            <Image
              src="/images/investor_logos/devc.svg"
              alt={`DeVC Logo`}
              width={200}
              height={100}
              className='w-56 h-8'
        ...
        {/* Angel Investors */}
        <div className='w-full flex items-center flex-col bg-white py-16'>
          <p className="font-display font-regular text-black text-4xl max-w-4xl text-center px-4">Angels</p>
          <div className="py-8" />
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 md:gap-16 items-center p-8">
            {angels.map((angel) => (

              <div key={angel.name} className="flex flex-col items-center text-center justify-center h-full w-full border border-gray-300 p-8 rounded-md bg-white shadow-sm">
