    ...
    <main className="flex flex-col items-center justify-between selection:bg-yellow-200/75">
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8 font-body">
          {/* Header */}
          <h1 className="text-5xl font-display text-black mb-2">Privacy Policy</h1>
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Scope</h2>
          <p className="mb-4 text-justify text-lg">
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Interpretation and Definitions</h2>

          <h3 className="text-2xl font-display text-black mt-6 mb-3">Interpretation</h3>
          <p className="mb-6 text-justify text-lg">
            The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
          </p>

          <h3 className="text-2xl font-display text-black mt-6 mb-3">Definitions</h3>
          ...
          <dl className="mb-8 space-y-4 text-lg">
            ...
            <div>
              <dt className="font-semibold text-black">Cookies</dt>
            ...
            <div>
              <dt className="font-semibold text-black">Personal Data</dt>
            ...
            <div>
              <dt className="font-semibold text-black">Service Provider</dt>
            ...
            <div>
              <dt className="font-semibold text-black">Usage Data</dt>
            ...
            <div>
              ...
              <dd className="mt-1 text-justify">refers to measure.sh, accessible from <Link target="_blank" className="underline decoration-2 underline-offset-2 decoration-yellow-200 hover:decoration-yellow-500" href="https://measure.sh">https://measure.sh</Link></dd>
            </div>
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Types of Data Collected</h2>
          <p className="mb-6 text-justify text-lg">
          ...
          <h3 className="text-2xl font-display text-black mt-6 mb-3">Personal Data</h3>
          <p className="mb-4 text-justify text-lg">
          ...
          <h3 className="text-2xl font-display text-black mt-6 mb-3">Usage Data</h3>
          <p className="mb-4 text-justify text-lg">
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Tracking Technologies and Cookies</h2>
          <p className="mb-4 text-justify text-lg">
          ...
          <div className="mb-6 space-y-4 text-lg">
            <div>
              <h4 className="font-semibold text-black mb-2">Necessary / Essential Cookies</h4>
            ...
            <div>
              <h4 className="font-semibold text-black mb-2">Functionality Cookies</h4>
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Use of Your Personal Data</h2>
          <p className="mb-4 text-justify text-lg">
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Retention of Your Personal Data</h2>
          <p className="mb-4 text-justify text-lg">
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Transfers of Your Personal Data</h2>
          <p className="mb-4 text-justify text-lg">
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Deletion of Your Personal Data</h2>
          <p className="mb-4 text-justify text-lg">
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Disclosure of Your Personal Data</h2>
          <h3 className="text-xl font-display text-black mt-6 mb-3">Business Transactions</h3>
          <p className="mb-6 text-justify text-lg">
          ...
          <h3 className="text-xl font-display text-black mt-6 mb-3">Law enforcement</h3>
          <p className="mb-6 text-justify text-lg">
            Under certain circumstances, the Company may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
          </p>

          <h3 className="text-xl font-display text-black mt-6 mb-3">Other legal requirements</h3>
          <p className="mb-4 text-justify text-lg">
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Security of Your Personal Data</h2>
          <p className="mb-8 text-justify text-lg">
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Links to Other Websites</h2>
          <p className="mb-4 text-justify text-lg">
          ...
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Changes to this Privacy Policy</h2>
          <p className="mb-4 text-justify text-lg">
          ...
          {/* Contact */}
          <h2 className="text-3xl font-display text-black mt-12 mb-4">Contact</h2>
          <p className="mb-8 text-justify text-lg">
            If you have questions about this Privacy Policy, you can contact us via email on <Link target="_blank" className="underline decoration-2 underline-offset-2 decoration-yellow-200 hover:decoration-yellow-500" href="mailto:hello@measure.sh">hello@measure.sh</Link>
          </p>
        </div>
