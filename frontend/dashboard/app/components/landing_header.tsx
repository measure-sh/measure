...
export default function LandingHeader() {
  ...
  return (
    <header
      ...
      className={cn(
        "w-full flex flex-col z-50 bg-white fixed top-0 transition-transform duration-100 ease-in-out",
        shouldHide ? "-translate-y-full" : "translate-y-0"
      )}
    >
      <div className="w-full flex flex-row justify-between items-center py-4 px-4">
        <Link
          className={cn(buttonVariants({ variant: "ghost" }), "py-2")}
          href="/"
        >
          <Image
