...
export default function SdkConfigSection({ appId, appName, initialConfig, currentUserCanChangeAppSettings, osName }: SdkConfigSectionProps) {
  ...
  const saveSdkConfigSection = async (
    section: 'traces' | 'crashes' | 'anrs' | 'launch_metrics' | 'journey' | 'masking' | 'http',
  ...
  const getJourneysConfirmBody = () => {
    return (
      <div className="font-body">
        <p>Are you sure you want to update user journey settings for app <span className="font-display font-bold">{appName}</span>?</p>
        <br />
        <p>The following changes will be applied:</p>
        <ul className="list-disc list-inside mt-2 space-y-1">
        ...
        <br />
        <p>These changes will apply to all new sessions.</p>
      </div>
    )
  }
        ...
        <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionContent className="bg-gray-50 px-4 py-4">
              <div className="pt-4 space-y-6">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-sm font-body">Collect session timeline with</span>
                  <SamplingRateInput
                    testId="crash-timeline-sampling-rate-input"
                    value={sdkConfig.crash_timeline_sampling_rate}
                    maxValue={100}
                    onChange={(value) => setSdkConfig({ ...sdkConfig, crash_timeline_sampling_rate: value })}
                    disabled={!currentUserCanChangeAppSettings}
                  />
                  <span className="text-sm font-body">% crashes</span>
                </div>
          ...
          <AccordionItem value="traces" className="mt-2">
            ...
            <AccordionContent className="bg-gray-50 px-4 py-4">
              <div className="pt-4 pb-2 space-y-4">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-sm font-body">Collect traces at</span>
                  <SamplingRateInput
          ...
          <AccordionItem value="launch" className="mt-2">
            ...
            <AccordionContent className="bg-gray-50 px-4 py-4">
              <div className="pt-4 space-y-6">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-sm font-body">Collect cold, warm and hot launch metrics at</span>
                  <SamplingRateInput
          ...
          <AccordionItem value="journeys" className="mt-2">
            <AccordionTrigger className="text-base font-body">User Journeys</AccordionTrigger>
            <AccordionContent className="bg-gray-50 px-4 py-4">
              <div className="pt-4 space-y-6">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-sm font-body">Collect user journeys for</span>
                  <SamplingRateInput
                    ...
                    disabled={!currentUserCanChangeAppSettings}
                  />
                  <span className="text-sm font-body">% sessions</span>
                </div>
                <div className="flex justify-end pt-2">
                  <Button
