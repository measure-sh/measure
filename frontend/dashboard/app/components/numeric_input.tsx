...
export default function NumericInput({
    ...
    const inputWidth = Math.max(minChars, localValue.length) + 8
    ...
    return (
        <input
            ...
            className="transition-[width] duration-150 ease-out border border-black rounded-md outline-hidden text-sm focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] py-2 px-4 font-body disabled:opacity-50 disabled:cursor-not-allowed"
        />
    )
}