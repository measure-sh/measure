        ...
        <div className="flex flex-col w-full">
            <div className="flex items-start justify-between w-full">
                <div className="flex flex-col">
                    ...
                    {!demo && <p className="mt-2 font-body text-xs text-muted-foreground"><Link href="https://github.com/measure-sh/measure/blob/main/docs/features/feature-network-monitoring.md#how-are-endpoint-patterns-generated" target="_blank" className={underlineLinkStyle}>Learn more</Link> about how endpoint patterns are generated</p>}
                </div>
