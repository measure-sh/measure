            ...
            {(demo || (pageState.filters.ready &&
                ...
                <>
                    ...
                    {!demo && (
                        <>
                            ...
                            <p className="mt-2 font-body text-xs text-muted-foreground">
                                ...
                                {' '}
                                <Link href="https://github.com/measure-sh/measure/blob/main/docs/features/feature-network-monitoring.md#searching-for-endpoints" target="_blank" className={underlineLinkStyle}>
                                    Learn more
                                </Link>
                    ...
                    <div className="w-full">
                        ...
                        <p className="mt-2 font-body text-xs text-muted-foreground">Distribution of when endpoint patterns are typically called in a session.{!demo && <>{' '}<Link href="https://github.com/measure-sh/measure/blob/main/docs/features/feature-network-monitoring.md#request-timeline" target="_blank" className={underlineLinkStyle}>Learn more</Link> about how the timeline is generated</>}</p>
