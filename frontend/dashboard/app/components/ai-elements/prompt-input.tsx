        ...
        >
          {data.mediaType?.startsWith("image/") && data.url ? (
            ...
            <div className="flex flex-col size-full items-center justify-center text-slate-500 dark:text-slate-400">
              ...
              <p className="text-[8px] w-full truncate px-2 mt-1">{data.filename}</p>
            </div>
          )}
          <Button
...
export const PromptInput = ({
  ...
  return (
    <AttachmentsContext.Provider value={ctx}>
      ...
      <form
        className={cn(
          "w-full divide-y overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-950",
          className
        )}
    ...
    return (
      <Button
        className={cn(
          ...
          variant === "ghost" && "text-slate-500 dark:text-slate-400",
