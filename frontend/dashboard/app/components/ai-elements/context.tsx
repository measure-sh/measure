...
const useContextValue = () => {
  ...
  if (!context) {
    throw new Error("Context components must be used within");
  }
      ...
      {children ?? (
        <>
          ...
          <div className="space-y-2">
            <Progress className="bg-slate-100 dark:bg-slate-800" value={usedPercent * PERCENT_MAX} />
          </div>
        </>
      )}
    </div>
...
export const ContextContentFooter = ({
  ...
  return (
    <div
      className={cn(
        "flex w-full items-center justify-between gap-3 bg-slate-100 p-3 text-xs dark:bg-slate-800",
        className
      )}
      {...props}
    >
...
export const ContextReasoningUsage = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="text-slate-500 dark:text-slate-400">Reasoning</span>
...
export const ContextCacheUsage = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="text-slate-500 dark:text-slate-400">Cache</span>
...
const TokensWithCost = ({
  ...
  <span>
    ...
    {costText ? (
      <span className="ml-2 text-slate-500 dark:text-slate-400">• {costText}</span>
    ) : null}
  </span>
);
