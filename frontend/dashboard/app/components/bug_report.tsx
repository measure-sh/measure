            ...
            {bugReportApiStatus === BugReportApiStatus.Success &&
                <div>
                    ...
                    <div className="flex flex-row">
                        {demo ? (
                            <div className={cn(buttonVariants({ variant: "outline" }))}>View Session</div>
                        ) : (
                            <Link href={`/${params.teamId}/sessions/${params.appId}/${bugReport.session_id}`} className={cn(buttonVariants({ variant: "outline" }))}>View Session</Link>
                        )}
                        <div className="px-2" />
                        <Button
                            variant="outline"
