    ...
    return (
        <div className="flex items-center justify-center relative py-10">
            ...
            <button
                ...
                className={`relative z-10 w-12 h-12 rounded-full border transition-colors flex items-center justify-center text-sm font-sans hover:bg-yellow-200 border-slate-300`}
            >
                {value}
            </button>
