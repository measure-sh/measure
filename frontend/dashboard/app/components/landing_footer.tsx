    ...
    <footer className="w-full border-t border-gray-200 py-12">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-16 justify-between w-full px-16">
        <div className='flex flex-col items-center'>
          <Image
            src="/images/measure_logo_horizontal.svg"
            width={200}
            height={80}
            alt={"Measure logo"}
          />
        ...
        <div className='flex flex-col items-center md:items-start gap-4'>
          <p className="text-black font-display text-2xl md:px-2">Product</p>
          <Link
        ...
        <div className='flex flex-col items-center md:items-start gap-4'>
          <p className="text-black font-display text-2xl md:px-2">Alternatives</p>
          <Link
        ...
        <div className='flex flex-col items-center md:items-start gap-4'>
          <p className="text-black font-display text-2xl md:px-2">Resources</p>
          <Link
            href="https://github.com/measure-sh/measure"
            target='_blank'
            className={cn(
        ...
        <div className='flex flex-col items-center md:items-start gap-4'>
          <p className="text-black font-display text-2xl md:px-2">Company</p>
          <Link
            href="/about"
            className={cn(
              buttonVariants({ variant: "ghost" }),
        ...
        <div className='flex flex-col items-center md:items-start gap-4'>
          <p className="text-black font-display text-2xl md:px-2">Legal</p>
          <Link
            href="/privacy-policy"
            className={cn(
              buttonVariants({ variant: "ghost" }),
        ...
        <div className='flex flex-col items-center md:items-start gap-4'>
          <p className="text-black font-display text-2xl md:px-2">Connect</p>
          <Link
            href="https://www.linkedin.com/company/measure-sh"
            target='_blank'
            className={cn(
              buttonVariants({ variant: "ghost" }),
              "font-display select-none w-full",
            )}
          >
            <Image
          ...
          <Link
            ...
            className={cn(
              buttonVariants({ variant: "ghost" }),
              "font-display select-none w-full py-2",
            )}
          >
            <Image
