        ...
        <div className="flex flex-col items-start">
            ...
            {traceApiStatus === TraceApiStatus.Success &&
                <div className="w-full">
                    ...
                    <div className="py-4" />
                    {demo ? (
                        <div className={cn(buttonVariants({ variant: "outline" }), "justify-center w-fit font-display border border-black rounded-md select-none")}>View Session</div>
                    ) : (
                        <Link href={`/${params.teamId}/sessions/${params.appId}/${trace.session_id}`} className={cn(buttonVariants({ variant: "outline" }), "justify-center w-fit")}>View Session</Link>
                    )}
                    <div className="py-4" />
