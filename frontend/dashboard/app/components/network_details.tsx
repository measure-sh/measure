    ...
    return (
        <div className="flex flex-col items-start w-full">
            ...
            {pageState.filters.ready && pageState.timelineApiStatus !== NetworkEndpointTimelinePlotApiStatus.NoData && <div className="flex flex-col w-full">
                ...
                <p className="mt-2 font-body text-xs text-muted-foreground">Distribution of when this endpoint is typically called in a session.{' '}<Link href="https://github.com/measure-sh/measure/blob/main/docs/features/feature-network-monitoring.md#request-timeline" target="_blank" className={underlineLinkStyle}>Learn more</Link> about how the timeline is generated.</p>
