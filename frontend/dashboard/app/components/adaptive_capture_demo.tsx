...
const AdaptiveCaptureDemo: React.FC<AdaptiveCaptureDemoProps> = ({
  showTitle,
}) => {
      ...
      <div className="w-full mx-auto">
        ...
        <div className="bg-accent border-2 border-border rounded-md p-4 mb-4 shadow-lg">
          <div className="flex items-center gap-2 mb-4">
            ...
            <p className="text-accent-foreground font-display">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
            {(
              Object.entries(configState) as [keyof ConfigState, DataConfig][]
            ).map(([key, config]) => {
                  ...
                  <div className="mt-3 pt-3 border-t border-border">
                    ...
                    {config.targeting > 0 && (
                      <div className="text-xs text-foreground mt-2">
                        🎯 {config.targeting}{" "}
                        {config.targeting === 1 ? "filter" : "filters"}
                      </div>
                    )}
                  </div>
                </div>
        ...
        <div className="flex justify-center mb-4">
          <div className="relative">
            ...
            <div className="flex flex-col items-center">
              ...
              <div
                className={`w-2 h-2 ${syncing ? "bg-primary animate-pulse" : "bg-foreground"} rounded-full`}
              ></div>
          ...
          <div className="bg-background border border-border rounded-md p-4">
            <div className="text-sm space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`${syncing ? "text-foreground" : "text-foreground"}`}
                >
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-foreground">
                  {Object.values(configState).filter((c) => isActive(c)).length}{" "}
              ...
              >
                <div className="flex flex-col items-start justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2.5 px-1">
                    <div
                      className={`w-1.5 h-1.5 rounded-full bg-foreground ${syncing ? "animate-pulse" : ""}`}
                    ></div>
