    ...
    <main className="flex flex-col items-center justify-between">
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8 font-body">
          ...
          <div className='flex flex-col md:flex-row w-full items-center gap-8 mt-24'>
            <div className='flex flex-col flex-1'>
              ...
              <p className="text-justify text-lg">
                ...
                <br /><br />
                If you&apos;re looking to truly understand what issues occur in your app, how they impact users and how to reproduce and fix them quickly, Measure is the right tool for you.
              </p>
            </div>
          ...
          <div className='flex flex-col md:flex-row w-full items-center gap-8 mt-24'>
            <div className='flex flex-col flex-1'>
              <h2 className="text-3xl font-display mb-4">Mobile Focus vs General Purpose</h2>
              <p className="text-justify text-lg">
                ...
                <br /><br />
                If you care about your app being treated with the respect and focus it deserves, Measure is the right choice for you.
              </p>
            </div>
            <div className='flex items-center justify-center w-full md:w-64 flex-shrink-0'>
          ...
          <div className='flex flex-col md:flex-row w-full items-center gap-8 mt-24'>
            <div className='flex flex-col flex-1'>
              ...
              <p className="text-justify text-lg">
                Measure is fully open-source and can be self-hosted or used via Measure Cloud. This means our code is open to scrutiny and community contributions which leads to a better product.
                <br /><br />
                If you value transparency, flexibility and community driven development, Measure is the right tool for you.
              </p>
            </div>
            <div className='flex items-center justify-center w-full md:w-64 flex-shrink-0'>
          ...
          <div className='flex flex-col md:flex-row w-full items-center gap-8 mt-24'>
            <div className='flex flex-col flex-1'>
              ...
              <p className="text-justify text-lg">
                ...
                <br /><br />
                If you hate playing with excel sheets and pricing calculators to figure out your monthly bill and would like to adjust your data collection based on changing needs, Measure is perfect for you.
              </p>
            </div>
            <div className='flex items-center justify-center w-full md:w-64 flex-shrink-0'>
