...
seoTitle: "Mobile App Launch Metrics"
...
You can see these metrics in the overview page of the dashboard and set the [sampling values](/docs/adaptive-capture) as per your needs.

![App Launch Metrics](/docs/assets/app-launch-metrics.webp)
