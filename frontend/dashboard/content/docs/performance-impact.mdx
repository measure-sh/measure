...
seoTitle: "Measure SDK Performance Impact and Benchmarks (Android and iOS)"
...
![Firebase Comparison](/docs/assets/android-firebase-bar-chart.webp)

Perfetto screenshot from one of the runs:

![Screenshot](/docs/assets/android-firebase-comparison.webp)
