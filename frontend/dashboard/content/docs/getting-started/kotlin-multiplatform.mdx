...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("sh.measure:measure-kmp:0.3.0")
        }
    }
}
```
...
- [Upload symbols](/docs/error-monitoring/upload-symbols) to get readable stack traces
- [Track screen views](/docs/navigation-tracking) to see how users move through your app
- [Track network requests](/docs/network-monitoring) to monitor API latency and failures
- [Identify users](/docs/api-reference#identify-users) to find the sessions of a specific user
- [Set up bug reports](/docs/bug-reports) to let users report issues from inside your app
- [Track handled errors](/docs/error-monitoring#track-a-handled-error) to report errors your app catches and recovers from
