...
npm install @measuresh/react-native@0.4.1
```
...
- [Upload symbols](/docs/error-monitoring/upload-symbols#react-native) to get readable stack traces
...
- [Upload over-the-air updates](/docs/error-monitoring/over-the-air-updates#react-native) to get readable stack traces from each update
