...
Attach attributes to a log to record context you can filter on later, like the screen name, an order ID, or a retry count. The extra context is what lets you find one log among thousands. See [Attribute limits](/docs/api-reference#attribute-limits) for the allowed keys and values.
