...
Control which logs are collected from the dashboard through [Adaptive Capture](/docs/adaptive-capture), so you can tune collection without shipping a new build.
...
See [Adaptive Capture](/docs/adaptive-capture) for the full list.
