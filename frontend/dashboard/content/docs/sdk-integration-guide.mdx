...
By default, the `measure-sh` iOS framework is integrated via Swift Package Manager (SPM). If you'd prefer to integrate it as a CocoaPods dependency instead, add the following to the top of your `Podfile`:
