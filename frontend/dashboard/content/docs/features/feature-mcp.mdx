...
Ask a natural language question to help debug an app and let [Measure Agent](/docs/features/feature-agent) work out the answer using the app's telemetry data.
