...
Measure's Slack integration lets you get debugging help from [Measure Agent](/docs/features/feature-agent) using your app's telemetry get alert notifications and receive daily summaries in your Slack workspace.
...
Once your workspace is connected, you can debug with [Measure Agent](/docs/features/feature-agent) without leaving Slack, asking in plain language:
...
See the [Measure Agent](/docs/features/feature-agent) guide for what you can ask and how it works.
