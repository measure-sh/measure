...
seoTitle: "App Size Monitoring (APK, AAB, IPA)"
...
Measure automatically tracks size of the IPA file for each version when you upload dSYMs using the [upload_dsym_xcarchive.sh](https://github.com/measure-sh/measure/blob/main/ios/Scripts/upload_dsym_xcarchive.sh) or [upload_dsym_manual.sh](https://github.com/measure-sh/measure/blob/main/ios/Scripts/upload_dsym_manual.sh) script.
