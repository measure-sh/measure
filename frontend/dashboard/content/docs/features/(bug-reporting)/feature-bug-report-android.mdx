...
seoTitle: "In-App Bug Reports - Android SDK"
...
|--------------------------------------------------|----------------------------------------------------|
| ![Dark Mode](/docs/assets/android-bug-report-dark.webp) | ![Light Mode](/docs/assets/android-bug-report-light.webp) |
...
You can apply a custom theme by overriding any of the values in the theme: [themes.xml](https://github.com/measure-sh/measure/blob/main/android/measure-android/measure/src/main/res/values/themes.xml).
...
For privacy, screenshots can be masked with the same configuration provided during SDK initialization. See all the configuration options [here](/docs/configuration-options#screenshot-mask-level).
