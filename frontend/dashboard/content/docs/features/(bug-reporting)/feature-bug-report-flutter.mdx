...
seoTitle: "In-App Bug Reports - Flutter SDK"
...
|-------------------------------------------------------|---------------------------------------------------------|
| ![Dark Mode](/docs/assets/flutter-ios-bug-report-dark.webp) | ![Light Mode](/docs/assets/flutter-ios-bug-report-light.webp) |

### Android

| Dark Mode                                                | Light Mode                                                 |
|----------------------------------------------------------|------------------------------------------------------------|
| ![Dark Mode](/docs/assets/flutter-android-bug-report-dark.webp) | ![Light Mode](/docs/assets/flutter-android-bug-report-light.webp) |
...
based on the [screenshot mask level](/docs/configuration-options#screenshot-mask-level) configuration.
