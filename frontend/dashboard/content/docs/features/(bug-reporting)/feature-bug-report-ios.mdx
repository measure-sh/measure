...
seoTitle: "In-App Bug Reports - iOS SDK"
...
|----------------------------------------------|------------------------------------------------|
| ![Dark Mode](/docs/assets/ios-bug-report-dark.webp) | ![Light Mode](/docs/assets/ios-bug-report-light.webp) |
...
<video
  ...
  preload="metadata"
  width="296"
  src="/docs/assets/ios-bug-report-demo.mp4"
  aria-label="Bug Report demo"
/>
...
Check out [BugReportConfig](https://github.com/measure-sh/measure/blob/main/ios/Sources/MeasureSDK/Swift/BugReport/BugReportConfig) to see all the configurable tokens.
