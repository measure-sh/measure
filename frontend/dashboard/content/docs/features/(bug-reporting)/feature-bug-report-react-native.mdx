---
title: "Bug Reports - React Native"
seoTitle: "In-App Bug Reports - React Native Package"
...
|-------------|----------------------------------------------|------------------------------------------------|
| iOS         | ![Dark Mode](/docs/assets/ios-bug-report-dark.webp) | ![Light Mode](/docs/assets/ios-bug-report-light.webp) |
| Android     | ![Dark Mode](/docs/assets/android-bug-report-dark.webp) | ![Light Mode](/docs/assets/android-bug-report-light.webp) |
...
configuration options [here](/docs/configuration-options#screenshot-mask-level).
