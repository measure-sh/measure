...
<Tabs groupId="platform" items={["Android", "iOS", "Flutter", "React Native"]} persist>
<Tab value="Android">
...
![Trace view](/docs/assets/trace-view.webp)
...
See [Configuration Options](/docs/configuration-options) for details on how to configure sampling for performance traces.
...
if the Activity was being loaded as part of a [cold](/docs/features/feature-app-launch-metrics#cold-launch) launch.
...
![screen-load-span.png](/docs/assets/android-screen-load-span.webp)
