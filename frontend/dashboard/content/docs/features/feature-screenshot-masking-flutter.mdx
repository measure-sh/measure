...
that match the configured [screenshot mask level](/docs/adaptive-capture#screenshot-mask-level).
...
[Screenshot Mask Level](/docs/adaptive-capture#screenshot-mask-level) for the full list of levels
