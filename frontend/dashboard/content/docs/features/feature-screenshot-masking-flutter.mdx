---
title: "Screenshot Masking for Flutter"
...
that match the configured [screenshot mask level](/docs/configuration-options#screenshot-mask-level).
...
[Screenshot Mask Level](/docs/configuration-options#screenshot-mask-level) for the full list of levels
