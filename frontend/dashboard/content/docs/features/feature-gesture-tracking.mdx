...
seoTitle: "Gesture Tracking with Layout Snapshots"
...
See [measure_build](https://github.com/measure-sh/measure/blob/main/flutter/packages/measure_build/README.md) package for more details.
...
the [measure_build](https://github.com/measure-sh/measure/blob/main/flutter/packages/measure_build/README.md) package to generate a comprehensive list of all
...
- The benchmark tests can be found in [Layout Snapshot Perf Tests](https://github.com/measure-sh/measure/blob/main/flutter/example/integration_test/layout_snapshot_performance_test.dart). 
...
- The time to generate the layout snapshot increases linearly with the depth of the widget tree.
- The benchmark tests can be found [here](https://github.com/measure-sh/measure/blob/main/flutter/example/integration_test/layout_snapshot_performance_test.dart).
