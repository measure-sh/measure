...
seoTitle: "Upgrade Measure Flutter SDK to v0.4.0"
...
about it in the [SDK initialization guide](/docs/sdk-integration-guide) documentation.

For more details, checkout the [configuration options](/docs/configuration-options) documentation.
...
[Layout Snapshots](/docs/features/feature-gesture-tracking#layout-snapshots-1) are now available for Flutter along with
a new `measure_build` package that can be used to enhance the layout snapshots with widgets declared in your
app. To learn more checkout the `measure_build` package [documentation](https://github.com/measure-sh/measure/blob/main/flutter/packages/measure_build/README.md).
