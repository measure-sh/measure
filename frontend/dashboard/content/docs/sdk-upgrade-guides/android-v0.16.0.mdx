...
seoTitle: "Upgrade Measure Android SDK to v0.16.0"
...
[documentation](/docs/features/feature-performance-tracing#limits). If a span name exceeds the maximum allowed length, it
