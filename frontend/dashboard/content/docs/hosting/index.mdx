...
- [Create a Google OAuth App](/docs/hosting/google-oauth)
- [Create a GitHub OAuth App](/docs/hosting/github-oauth)
...
- [Set up SMTP email provider](/docs/hosting/smtp-email)
...
- [Set up Slack Integration](/docs/hosting/slack)
...
For certain target versions, you will need to run extra migration scripts. Check out our [Migration Guides](/docs/hosting/migration-guides).
