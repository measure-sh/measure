...
Starting with `v0.12.x`, the Measure MCP endpoint URL format has changed. Additionally, you can set up the Measure Agent as well. Visit the [Set up Measure Agent](/docs/hosting/agent) guide for instructions. After the setup reauthorize the remote [MCP server in your coding agents](/docs/mcp#setup).
