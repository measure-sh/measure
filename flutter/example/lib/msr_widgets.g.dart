...
import 'package:measure_flutter_example/main.dart';
import 'package:measure_flutter_example/src/layout_snapshot_page.dart';
...
import 'package:measure_flutter_example/src/screen_text_overflow.dart';
import 'package:measure_flutter_example/src/toggle_list_item.dart';

const Map<Type, String> widgetFilter = {
  AppBar: 'AppBar',
  Center: 'Center',
  Container: 'Container',
  ...
  LayoutSnapshotPage: 'LayoutSnapshotPage',
  ListItem: 'ListItem',
  ...
  ScreenTextOverflow: 'ScreenTextOverflow',
  Switch: 'Switch',
  Text: 'Text',
