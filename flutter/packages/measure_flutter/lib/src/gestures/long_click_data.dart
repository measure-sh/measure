...
part 'long_click_data.g.dart';

@JsonSerializable()
class LongClickData implements JsonSerialized {
  final String target;
  ...
  static LongClickData fromJson(Map<String, dynamic> json) =>
      _$LongClickDataFromJson(json);
}
