...
func (af *AppFilter) Expand(ctx context.Context, pg *pgxpool.Pool) (err error) {
	var filters *FilterList
	if af.FilterShortCode != "" {
		filters, err = GetFiltersFromCode(ctx, pg, af.FilterShortCode, af.AppID)
...
// types.
func (af AppFilter) getAppVersions(ctx context.Context, rch driver.Conn) (versions, versionCodes []string, err error) {
...
func (af AppFilter) getOSVersions(ctx context.Context, rch driver.Conn) (osNames, osVersions []string, err error) {
	table := config.AppFiltersTable
...
//
// Additionally, filters `exception` and `anr` event types.
func (af AppFilter) getCountries(ctx context.Context, rch driver.Conn) (countries []string, err error) {
	table := config.AppFiltersTable
...
//
// Additionally, filters `exception` and `anr` event types.
func (af AppFilter) getNetworkProviders(ctx context.Context, rch driver.Conn) (networkProviders []string, err error) {
	table := config.AppFiltersTable
...
//
// Additionally, filters `exception` and `anr` event types.
func (af AppFilter) getNetworkTypes(ctx context.Context, rch driver.Conn) (networkTypes []string, err error) {
	table := config.AppFiltersTable
...
//
// Additionally, filters `exception` and `anr` event types.
func (af AppFilter) getNetworkGenerations(ctx context.Context, rch driver.Conn) (networkGenerations []string, err error) {
	table := config.AppFiltersTable
...
//
// Additionally, filters `exception` and `anr` event types.
func (af AppFilter) getDeviceLocales(ctx context.Context, rch driver.Conn) (deviceLocales []string, err error) {
	table := config.AppFiltersTable
...
//
// Additionally, filters `exception` and `anr` event types.
func (af AppFilter) getDeviceManufacturers(ctx context.Context, rch driver.Conn) (deviceManufacturers []string, err error) {
	table := config.AppFiltersTable
...
//
// Additionally, filters `exception` and `anr` event types.
func (af AppFilter) getDeviceNames(ctx context.Context, rch driver.Conn) (deviceNames []string, err error) {
	table := config.AppFiltersTable
...
func (af AppFilter) getUDAttrKeys(ctx context.Context, rch driver.Conn) (keytypes []udattr.UDKeyType, err error) {
