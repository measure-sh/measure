...
func newTestSub(planID string, startedAt int64) autumn.Subscription {
	return autumn.Subscription{PlanID: planID, StartedAt: startedAt}
}
...
func TestFirePurchaseEvent(t *testing.T) {
	...
	t.Run("fires for Pro plan with full payload", func(t *testing.T) {
		...
		firePurchaseEvent(teamID, owner, customerID, newTestSub(AutumnPlanPro, startedAt))
		flushPostHog()
	...
	t.Run("skips for Free plan", func(t *testing.T) {
		...
		firePurchaseEvent(teamID, owner, customerID, newTestSub(AutumnPlanFree, startedAt))
		flushPostHog()
	...
	t.Run("skips for plan with no price-map entry", func(t *testing.T) {
		...
		firePurchaseEvent(teamID, owner, customerID, newTestSub("measure_enterprise_custom", startedAt))
		flushPostHog()
...
func TestFireSubscriptionUpgradedEvent(t *testing.T) {
	...
	t.Run("fires for Pro plan with full payload", func(t *testing.T) {
		...
		fireSubscriptionUpgradedEvent(teamID, owner, customerID, newTestSub(AutumnPlanPro, startedAt))
		flushPostHog()
	...
	t.Run("skips for Free plan", func(t *testing.T) {
		...
		fireSubscriptionUpgradedEvent(teamID, owner, customerID, newTestSub(AutumnPlanFree, startedAt))
		flushPostHog()
...
func TestFireSubscriptionDowngradedEvent(t *testing.T) {
	...
	fireSubscriptionDowngradedEvent(teamID, owner, customerID, newTestSub(AutumnPlanFree, startedAt))
	flushPostHog()
