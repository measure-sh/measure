	...
	return []compactionCase{
		{
			...
			history: []chatMessage{
				...
				toolResultMsg("call_1", `[{"type":"java.lang.NullPointerException","file_name":"CheckoutActivity.kt","method_name":"onPlaceOrderClicked","count":142,"users":97,"sessions":118},{"type":"java.lang.OutOfMemoryError","file_name":"ProductGalleryAdapter.kt","method_name":"onBindViewHolder","count":96,"users":71,"sessions":80},{"type":"java.lang.IllegalStateException","file_name":"PaymentFragment.kt","method_name":"onPaymentResult","count":62,"users":40,"sessions":51}]`),
				...
				toolResultMsg("call_3", `[{"type":"EXC_BAD_ACCESS","file_name":"CartViewController.swift","method_name":"tableView(_:cellForRowAt:)","count":58,"users":33,"sessions":45}]`),
