...
export class InvalidSpan implements Span {
  ...
  setParent(_parentSpan: Span): Span {
    return this;
  }
  setCheckpoint(_name: string): Span {
    return this;
  }
  setName(_name: string): Span {
    return this;
  }
  setAttribute(_key: string, _value: string | number | boolean): Span {
    return this;
  }
  setAttributes(_attributes: { [key: string]: ValidAttributeValue }): Span {
    return this;
  }
  removeAttribute(_key: string): Span {
    return this;
  }
  end(_timestampMs?: number): Span {
    return this;
  }
  hasEnded(): boolean {
    return false;
