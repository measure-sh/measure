...
project, please follow the instructions [here](../../android/README.md#getting-started).
...
> the build will fail. Read more about it [here](../../android/README.md#getting-started).
