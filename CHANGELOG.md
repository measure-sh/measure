...
- (**backend**): Support custom events (#1554) by @detj
- (**backend**): Support user defined attributes (#1529) by @detj
...
- (**frontend**): Don't update filters on selectedApp change by @anupcowkur
...
- (**backend**): Add new sessions by @abhaysood
...
- (**backend**): Update sessionator deps (#1553) by @detj
- (**backend**): Remove unused code (#1545) by @detj
- (**backend**): Add sample sessions by @abhaysood
...
- (**frontend**): Support attachments for gesture click by @abhaysood
...
- (**backend**): Document short filters api (#1552) by @detj
- (**backend**): Document rename app api (#1547) by @detj

## [0.4.1] - 2024-11-11

### :bug: Bug fixes

- (**backend**): Use specific clickhouse image version (#1517) by @detj

### :books: Documentation

- (**backend**): Fix typos and missing info (#1513) by @detj

## [0.4.0] - 2024-11-07

### :sparkles: New features

- (**backend**): Use short codes for list filters by @anupcowkur

### :bug: Bug fixes

- (**backend**): Validate limit to not be zero (#1500) by @detj
- (**backend**): Incorrect pagination when no data (#1499) by @detj
- (**backend**): Optimize session detail apis and overall loading experience (#1490) by @detj
- (**frontend**): Handle no data case for sessions list by @anupcowkur
- (**frontend**): Truncate matched free text by @anupcowkur
- (**frontend**): Better pagination in session detail (#1491) by @detj
- (**frontend**): Handle empty attr distributions by @anupcowkur

### :hammer: Misc

- (**backend**): Add migration guide & script for next version (#1512) by @detj
- (**backend**): Remove backfilling migrations (#1511) by @detj
- (**backend**): Change postgres compose config (#1509) by @detj
- (**backend**): Change index type in sessions table (#1505) by @detj
- (**backend**): Add skip indexes for sessions table (#1492) by @detj
- (**frontend**): Set default session type filter to all issues by @anupcowkur
- (**frontend**): Update landing page exceptions video by @anupcowkur
- (**frontend**): Standardise paginator UI by @anupcowkur
- (**frontend**): Cancel in-flight requests by @anupcowkur
- (**frontend**): Update exceptions landing video by @anupcowkur

### :books: Documentation

- (**backend**): Document sessions overview list api (#1502) by @detj
- Update exceptions demo video in README by @anupcowkur
- Update exceptions demo video in README by @anupcowkur
...
- (**frontend**): Replace exception detail journey with attr distribution plot by @anupcowkur
- (**frontend**): Add new UI for session replay by @anupcowkur
- (**frontend**): Persist paginator on master detail nav by @anupcowkur
- (**frontend**): Add search bar to dropdown component by @anupcowkur
- (**frontend**): Use sankey graphs for journeys by @anupcowkur
- (**frontend**): Add filters to urls by @anupcowkur

### :bug: Bug fixes

- (**backend**): Improve crash/anr detail experience (#1451) by @detj
- (**backend**): Improve dashboard api response times (#1404) by @detj
- (**backend**): Occasional runtime panic during ingestion (#1345) by @detj
- (**backend**): Increase app version character limit (#1342) by @detj
- (**backend**): Increase thread name character limit (#1341) by @detj
- (**backend**): Prevent duplicate ingestion of events (#1331) by @detj
- (**backend**): Improve security posture (#1303) by @detj
- (**frontend**): Crash detail not showing id (#1453) by @detj
- (**frontend**): Hot launch metric was incorrectly showing warm launch metric (#1448) by @detj
- (**frontend**): Some dashboard apis were failing due to lack of url encoding (#1449) by @detj
- (**frontend**): Handle empty mem/cpu graph in session replay by @anupcowkur
- (**frontend**): Calculate time diff b/w filtered events by @anupcowkur
- (**frontend**): Fix nav aside scroll on detail content exceeding screen area by @anupcowkur
- (**frontend**): Handle empty file/method name by @anupcowkur
- (**frontend**): Handle empty file/method name for crashes/anrs by @anupcowkur
- (**frontend**): Limit height of dropdown component by @anupcowkur
- (**frontend**): Improve exception/anr details plot ui by @anupcowkur
- (**frontend**): Disable appending filters to URLs by @anupcowkur
- (**frontend**): Update app name on selected app change by @anupcowkur
- (**frontend**): Improve security posture (#1305) by @detj

### :hammer: Misc

- (**backend**): Remove deprecated cliff feature (#1462) by @detj
- (**backend**): Apply suitable restart policy (#1458) by @detj
- (**backend**): Add data skipping indexes for fingerprints (#1455) by @detj
- (**backend**): Prevent db statement leaks (#1318) by @detj
- (**backend**): Search sessions by screen view by @abhaysood
...
- (**frontend**): Improve exception details loading state by @anupcowkur
- (**frontend**): Update default time filter to last 6 hours by @anupcowkur
- (**frontend**): Update landing page videos by @anupcowkur
- (**frontend**): Add loading states by @anupcowkur
- (**frontend**): Remove legends & add versions in tooltips to exception & sessions overview plots by @anupcowkur
- (**frontend**): Add loading spinners for plot components by @anupcowkur
- (**frontend**): Go directly to dashboard if logged in by @anupcowkur

### :books: Documentation

- (**backend**): Update incorrect json key name (#1363) by @detj
- Improve spelling in readme (#1460) by @detj
- Add videos to README by @anupcowkur
- Add call to action for star to README by @gandharva

## [0.2.1] - 2024-09-25

### :bug: Bug fixes

- (**backend**): Crash/anr details instances plot won't load sometimes (#1298) by @detj
- (**frontend**): Add option to handle no data & not onboarded in filters by @anupcowkur

### :books: Documentation

- Update release one liner command (#1294) by @detj
...
- (**backend**): Track email on new user sign in by @anupcowkur
- (**backend**): Improve session explorer by @anupcowkur
- (**backend**): Add session explorer with text search filter by @anupcowkur
- (**frontend**): Add custom error page by @anupcowkur
- (**frontend**): Add custom 404 page by @anupcowkur
- (**frontend**): Update tooltips by @anupcowkur
...
- (**backend**): Overview instance plot would not load for some cases (#1288) by @detj
- (**backend**): Round crash rate metrics to 2 decimal places by @anupcowkur
...
- (**backend**): Capture more details in otel traces (#1289) by @detj
- (**backend**): Add new sessions by @abhaysood
...
- (**backend**): Add self host upgrade guide (#1291) by @detj
